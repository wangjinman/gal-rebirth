...
label lindao_day10:
    ...
    show lindao gentle at LEFT with dissolve
...
label lindao_day13:
    ...
    show lindao thinking at LEFT with dissolve
...
label lindao_day16:
    ...
    label lindao_day16_first_attempt_fail:
        ...
        show lindao angry at LEFT with dissolve
...
label lindao_day17:
    ...
    narrator "他递过一张纸。"
    zhao_xuran "这是东京大学的申请资料，我表哥发给我的。"
...
label lindao_day25:
    ...
    narrator "这一刻，我觉得自己是如果幸福有形状，大概就是现在这样吧。。"
