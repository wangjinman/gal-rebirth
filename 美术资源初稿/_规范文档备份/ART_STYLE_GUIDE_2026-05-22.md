...
| `UI_choice_normal.png` | 选项按钮 · 普通（800×90 RGBA） |
| `UI_choice_hover.png` | 选项按钮 · 悬停（橙框+光晕） |
| `UI_choice_selected.png` | 选项按钮 · 选中（淡橙填充） |

规范：`UI\DIALOGUE_UI_MINIMAL_SPEC.md` · `UI\UI_CHOICE_BUTTON_SPEC.md`  
重建：`UI\scripts\build_choice_buttons.py`  
