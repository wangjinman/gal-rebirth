...
**引擎推荐文件**：`*-transparent-v1-feather.png`（羽化版）  
...
## 三、林晚棠 A 套 · 2026-05-19 已交付清单

| 表情 | 羽化版（推荐） |
|------|----------------|
| 站立 | `lin-wantang-standing-transparent-v1-feather.png` |
| 微笑 | `lin-wantang-expr-smile-v3-transparent-v1-feather.png` |
| 害羞 | `lin-wantang-expr-shy-v3-transparent-v1-feather.png` |
| 忧虑 | `lin-wantang-expr-worried-v2-transparent-v1-feather.png` |
| 哭泣 | `lin-wantang-expr-crying-v2-transparent-v1-feather.png` |
| 感动落泪 | `lin-wantang-expr-crying-moved-v3-transparent-v1-feather.png` |
| 惊喜 | `lin-wantang-surprised-v4-transparent-v1-feather.png` |
...
*维护：新增表情时复制本节流程，一张一张做，完成后把文件名补进第三节表格。*
